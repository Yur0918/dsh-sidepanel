...
[data-conversation-scroll] [class*="flowItem"].dsp-main-sticky{--dsp-pin-h:76px}
...
`;
		...
		// Only ONE user row may be sticky at a time — CSS sticky on every row
			...
			// expansion of the folded pinned bar; resets when the pin moves
			...
			function ensureStickyToggle(item, mode) {
				...
				chip.textContent = mode === "expanded" ? "收起 ⌃" : "展开 ⌄";
			}
